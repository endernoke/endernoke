...
|------|-------------|:----------:|--------------|------------|:------:|
| Soular | A one-stop social media platform for youths to complete the conception, coordination and publicity of environmental initiatives. <br /> **Runner-up of JA Code for Impact 2025 Hackathon** | Coming soon | React Native, Expo, Supabase, PostgreSQL | [soular](https://github.com/endernoke/soular) | Pre-release |
| VSCode Cheerleader | Supercharge your dev experience with an anime coding companion. | [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=cheerleader.cheerleader) | TypeScript, VS Code Extension API, ElevenLabs, Electron, Live2D Cubism | [vscode-cheerleader](https://github.com/georgeistes/vscode-cheerleader) | maintenance |
| Instagram CLI | The ultimate weapon against brainrot - Chat on Instagram in the terminal. | [PyPI package](https://pypi.org/project/instagram-cli/) | Python, Typer, Curses | [instagram-cli](https://github.com/supreme-gg-gg/instagram-cli/) | Maintenance |
